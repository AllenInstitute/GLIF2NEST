...
def create_lif_r_psc(config, syn_tau):
...
def create_lif_asc_psc(config, syn_tau):
...
def create_lif_r_asc_psc(config, syn_tau):
...
def create_lif_r_asc_a_psc(config, syn_tau):
