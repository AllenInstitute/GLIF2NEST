...
Description:
  ...
  and a voltage dependent threshold model).
...
inline nest::port
allen::glif_lif_r_asc_a::send_test_event( nest::Node& target,
...
inline nest::port
allen::glif_lif_r_asc_a::handles_test_event( nest::SpikeEvent&,
  nest::port receptor_type )
{
  if ( receptor_type != 0 )
...
inline nest::port
allen::glif_lif_r_asc_a::handles_test_event( nest::CurrentEvent&,
  nest::port receptor_type )
{
  if ( receptor_type != 0 )
    throw nest::UnknownReceptorType( receptor_type, get_name() );
...
inline nest::port
allen::glif_lif_r_asc_a::handles_test_event( nest::DataLoggingRequest& dlr,
  nest::port receptor_type )
{
  if ( receptor_type != 0 )
    throw nest::UnknownReceptorType( receptor_type, get_name() );
